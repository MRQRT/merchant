...
const sentyDSN = 'https://8161ef921ff74aecb9b453971890da59@sentry.au32.cn/13';
process.env.NODE_ENV === 'production' && window.location.host == "cjtsh.au32.cn" && Raven.config(sentyDSN,
{
    environment: 'prod'
},
{
